...
import com.practical.model.TagTrack
...
class TrackDetailsAdapter(
    ...
    private var arrayList: List<TagTrack>
) : RecyclerView.Adapter<TrackDetailsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        v = LayoutInflater.from(parent.context)
            .inflate(R.layout.raw_tag_album_details, parent, false)
