 ...
 */
class GenreCategoryPresenter(internal var view: GenreCategoryView) {

    fun getGenreCategory() {
        API()
            .getGenreCategory()
            .getObjectObservable(GenreCategoryResponse::class.java)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(object : Observer<GenreCategoryResponse> {
                override fun onSubscribe(d: Disposable) {
                    view.showProgress()
                }

                override fun onNext(data: GenreCategoryResponse) {
                    view.successGenreCategoryList(data)
                }
